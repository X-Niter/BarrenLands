...
public class BarrenBiomeProvider extends BiomeSource {

    public static final Codec<BarrenBiomeProvider> CODEC = RegistryOps.retrieveRegistry(Registry.BIOME_REGISTRY)
            .xmap(BarrenBiomeProvider::new, BarrenBiomeProvider::getBiomeRegistry).codec();

    private final Holder<Biome> biome;
    private final Registry<Biome> biomeRegistry;
    private static final List<ResourceKey<Biome>> SPAWN = Collections.singletonList(Biomes.PLAINS);

    public BarrenBiomeProvider(Registry<Biome> biomeRegistry) {
